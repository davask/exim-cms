...
class DwlLexExtension extends Extension implements PrependExtensionInterface
{
    /**
    ...
    public function prepend(ContainerBuilder $container)
    {
        ...
        $prependConfig = array(
            'persistence' => array(
                'phpcr' => array(
                    'basepath' => '/cms/lex',
                    'document_class' => 'Dwl\LexBundle\Document\Dictum',
                ),
            ),
        );

        $container->prependExtensionConfig('dwl_lex', $prependConfig);
    }
