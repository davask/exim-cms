...
(function(root, factory) {
    ...
    var DEFAULTS = {
        /**
         * Class names to be added on ul element
         * @type {String}
         */
        additionalTagListClasses: '',

        /**
         * Class names to be added on li element parent of input
         * @type {String}
         */
        additionalTagListLiClasses: '',

        /**
         * Class names to be added on input element
         * @type {String}
         */
        additionalTagListLiInputClasses: '',
    ...
    var Taggle = function(el, options) {
        ...
        if (!this.settings.bootstrapInput) {
            this.inputLi.className = this.settings.additionalTagListLiInputClasses;
        } else {
            this.inputLi.className = "col-xs-12 " + this.settings.additionalTagListLiInputClasses;
        }
    ...
    Taggle.prototype._setupTextarea = function() {
        ...
        this.list.className = 'taggle_list ' + this.settings.additionalTagListClasses;
        ...
        this.input.className = 'taggle_input ' + this.settings.additionalTagListLiInputClasses;
