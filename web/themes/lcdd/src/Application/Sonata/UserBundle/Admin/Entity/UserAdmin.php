        ...
        $formMapper
            ->tab('User')
                ...
                ->with('Social')
                    ...
                    ->add('youtubeUid', null, array('required' => false))
                    ->add('youtubeName', null, array('required' => false))
                    ->add('linkedinUid', null, array('required' => false))
                    ->add('linkedinName', null, array('required' => false))
                ->end()
            ->end()
            ->tab('Security')
                ->with('Status')
