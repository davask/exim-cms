...
if (isset($_SERVER['HTTP_CLIENT_IP'])
    ...
    || !(in_array(@$_SERVER['REMOTE_ADDR'], array('127.0.0.1', 'fe80::1', '::1', $ErlangenKirchenstarsse92ndfloor, $ErlangenKirchenstarsse91stfloor, $lcddHome)) || php_sapi_name() === 'cli-server')
) {
